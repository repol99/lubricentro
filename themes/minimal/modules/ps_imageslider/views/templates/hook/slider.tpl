          ...
          <a href="#">
            <figure>
              ...
              {if $slide.title || $slide.description}
                <figcaption class="caption" style="text-align:center !important;left: 50%;-webkit-transform: translate(-50%,-50%);transform: translate(-50%,-50%);top:40%; max-width:700px; width:700px;">
                  <div class="caption-description">{$slide.description nofilter}</div>
                  <a class="btn btn-primary" href="{$slide.url}">{$slide.title}</a>
